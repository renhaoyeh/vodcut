  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "group peer flex h-full shrink-0 flex-col overflow-hidden bg-sidebar text-sidebar-foreground transition-[width] duration-200 ease-linear",
          "w-[--sidebar-width]",
          collapsible === "icon" && "group-data-[state=collapsed]:w-[--sidebar-width-icon]",
          collapsible === "offcanvas" && "group-data-[state=collapsed]:w-0 group-data-[state=collapsed]:overflow-hidden",
